  ...
  const panelSets = [
    ...
    },
    {
      ...
      samples: [
        {
          text: "Hotel Tour",
          url: "React_VR_Prerelease/dist/TourSample/index.html",
          description: "A beautiful virtual hotel tour!",
        },
        {
          text: "Cube Geometry",
          url: "React_VR_Prerelease/dist/CubeSample/index.html",
          description: "Use and Change Cube Geometry!",
        },
        {
          text: "Flexbox Layout",
          url: "React_VR_Prerelease/dist/LayoutSample/index.html",
          description: "Layout UI Panels using Flexbox!",
        },
        {
          text: "Mesh Import",
          url: "React_VR_Prerelease/dist/MeshSample/index.html",
